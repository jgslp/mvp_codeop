      ...
      {tableData.map((data) => {
       return (
        <tr key={data.id}>
            ...
            <td>{data.birthdate ? data.birthdate.toString().substring(0, 10).split("-").reverse().join("-") : "——"}</td>
            <td>{data.annual ? data.annual.toString().substring(0, 10).split("-").reverse().join("-")  : "——"}</td>
            <td>{data.triennial ? data.triennial.toString().substring(0, 10).split("-").reverse().join("-")  : "——"}</td>
